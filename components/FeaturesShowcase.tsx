        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <MotionReveal delay={0.15} yOffset={24}>
              ...
              <p className="text-sm sm:text-base text-zinc-400 leading-relaxed font-normal mt-4">
              ...
              <p className="text-sm sm:text-base text-zinc-400 leading-relaxed font-normal mt-3">
